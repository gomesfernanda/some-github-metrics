...
def export_traffic(directory, organization, repos_ok, authtoken):
    ...
    for i in reposlist:
        count+=1
        print("[", count.zfill(2), "|", len(repos_ok), "] - views for", i)
    ...
    for i in reposlist:
        count += 1
        print("[", count.zfill(2), "|", len(repos_ok), "] - clones for", i)
    ...
    for i in reposlist:
        count +=1
        print("[", count.zfill(2), "|", len(repos_ok), "] - paths for", i)
    ...
    for i in reposlist:
        count+=1
        print("[", count.zfill(2), "|", len(repos_ok), "] - referrers for", i)
